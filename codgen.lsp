; codgen.lsp       Generate Assembly Code for SPARC          25 Apr 01
...
(defun genc (code)
  (let (tok lhs rhs reg offs sym)
	...
	(asmst 'ST reg FP offs (tokenval lhs)) ) ) ))  ; store value into lhs
